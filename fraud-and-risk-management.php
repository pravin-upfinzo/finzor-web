...
<section id="fz_product_list_hero_sec" class="section_start" active-menu="list-menu-service" active-submenu="finvigil">
    ...
    <section id="fz_product_list_banner_sec">
        <div class="container">
            <img src="./assets/images/product_banner/fraud_and_risk management.svg" alt="product-banner" class="fz_product_list_banner_img">
        </div>
    </section>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 fz_enhance_img_col">
                <div class="fz_ai_enhance_img zoom-in-cbs">
                    <img src="./assets/images/product_sec_1_images/fraud_and_risk_management_sec1.svg" alt="CBS">
                </div>
            </div>
        </div>
    </div>
...
<section class="fz_features_sec">
    <div class="container">
        <h2>AI-Driven Financial Security
        </h2>
        <p class="fz_features_heading_para">Finzor enhances financial security with AI-driven fraud detection and risk management. Our real-time monitoring, behavioral biometrics, and deep learning prevent fraud before it happens. AI-driven risk analysis optimizes credit assessments, market predictions, and stress testing to safeguard businesses.  </p>
        <div class="row">
            <div class="col-lg-6">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="onTabClick('v-pills-home')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Next-Gen Fraud Prevention</h4>
                        </div>
                        <p class="fz_feature_para">
                        Secure transactions with AI-driven fraud detection, real-time monitoring, and behavioral biometrics for proactive security.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="onTabClick('v-pills-profile')">
                        ...
                        <p class="fz_feature_para">
                        Leverage AI to assess creditworthiness, monitor portfolios, predict market changes, and optimize financial decision-making.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="onTabClick('v-pills-messages')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>AI-Powered Financial Security</h4>
                        </div>
                        <p class="fz_feature_para">
                        Advanced AI models protect businesses by detecting fraud, mitigating risks, and ensuring regulatory compliance.
                        </p>
                    </button>
                </div>
            </div>
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        <div class="fz_features_img zoom-in-fe">
                            <img src="./assets/images/product_tab_images/finvigil_01.svg" alt="finvigil">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        <div class="fz_features_img zoom-in-fe">
                            <img src="./assets/images/product_tab_images/finvigil_02.svg" alt="finvigil">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <div class="fz_features_img zoom-in-fe">
                            <img src="./assets/images/product_tab_images/finvigil_03.svg" alt="finvigil">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="fz_ai_enhance_img zoom-in-sec3">
                    <img src="./assets/images//product_sec_3_images/finvigil.svg" alt="">
                </div>
            </div>
            <div class="col-lg-7 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    <h2>Strategic Risk Intelligence </h2>
                    <p class="fz_enhance_para">Market Risk Prediction analyzes historical data and market trends to forecast potential financial risks, enabling proactive decision-making. Stress Testing evaluates an institution’s resilience under extreme economic conditions, ensuring regulatory compliance and financial stability. Scenario Analysis examines multiple hypothetical market conditions, helping businesses strategize for both risks and opportunities. Together, these techniques enhance risk management, improve financial planning, and strengthen long-term stability in dynamic market environments.
                    </p>
                    <ul>
                        <li>
