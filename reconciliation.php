...
<section id="fz_product_list_banner_sec">
    <div class="container">
        <img src="./assets/images/Reconciliation.svg" alt="product-banner" class="fz_product_list_banner_img">
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-6 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    ...
                    <ul>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color">Boost Accuracy with AI Precision</span><span class="normal_text"> Eliminate manual errors and ensure precise financial reconciliation.</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color">Save Time with Lightning-Fast Processing</span><span class="normal_text"> Process vast data volumes in minutes, reducing costs and delays.
</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="normal_text"> Instant Fraud Detection for Risk Mitigation <span class="fz_cbs_color">Identify and address unusual transaction patterns in real-time.</span></span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="product_list_feature_cards spotlight-effect">
            ...
            <div class="product_list_feature_card fade-right">
                <div class="product_list_feature_cont">
                    <img src="./assets/images/product_feature_digital.svg" alt="digital payment">
                    <h4>Discrepancy Alerts and Notifications</h4>
                    <p>Notifies users of any mismatches or issues in transactions.</p>
                </div>
            </div>
...
<section class="fz_features_sec">
    <div class="container">
        <h2>Reconciliation with Generative AI</h2>
        <p class="fz_features_heading_para">Finzor’s Generative AI streamlines payment reconciliation by automating data cleansing, pattern recognition, and predictive analytics. Enhance accuracy, efficiency, and security in financial operations.</p>
        <div class="row">
            <div class="col-lg-6">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="onTabClick('v-pills-home')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Automated Data Cleansing & Transformation</h4>
                        </div>
                        <p class="fz_feature_para">
                        Generative AI automatically cleans and transforms raw payment data, eliminating errors and preparing it for seamless, error-free reconciliation.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="onTabClick('v-pills-profile')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>AI-Powered Pattern Recognition & Analysis</h4>
                        </div>
                        <p class="fz_feature_para">
                        Leverage AI to identify complex patterns and anomalies in your data. Detect trends, flag discrepancies, and ensure smoother, more efficient reconciliation processes.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="onTabClick('v-pills-messages')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Proactive & Secure Reconciliation with AI</h4>
                        </div>
                        <p class="fz_feature_para">
                        Predict future challenges and reduce manual workloads with AI-driven automation. Enhance security by detecting suspicious transactions and ensuring accuracy across your financial operations.
                        </p>
                    </button>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    <h2>Future of Payment Reconciliation </h2>
                    ...
                    <ul>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color">Match transactions accurately </span><span class="normal_text"> to avoid discrepancies.</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color">Automate reports & tracking </span><span class="normal_text"> for seamless reconciliation.</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color">Ensure financial accuracy</span><span class="normal_text"> with real-time data insights.
                            </span>
                        </li>
                    </ul>
                </div>
