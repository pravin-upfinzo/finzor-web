...
<section id="fz_product_list_hero_sec" class="section_start" active-menu="list-menu-service" active-submenu="finopz" active-submenu-l2="finopz-reconciliation">
    ...
    <div class="container">
        <div class="product_list_hero">
            <h2 class="product_list_hero_title">Reconcile Your Vision with Reality by <span> FinzRec</span></h2>
    ...
    <section id="fz_product_list_banner_sec">
        <div class="container">
            <img src="./assets/images/product_banner/reconciliation.svg" alt="product-banner" class="fz_product_list_banner_img">
        </div>
    </section>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 fz_enhance_img_col">
                <div class="fz_ai_enhance_img zoom-in-cbs">
                    <img src="./assets/images/product_sec_1_images/reconciliation_sec1.svg" alt="CBS">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6 fz_tab_images_features">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        ...
                        <img src="./assets/images/product_tab_images/finrec_01.svg" alt="finrec_01">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/finrec_02.svg" alt="finrec_02">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/finrec_03.svg" alt="finrec_03">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="fz_ai_enhance_img zoom-in-sec3">
                    <img src="./assets/images//product_sec_3_images/finzrec.svg" alt="">
                </div>
            </div>
