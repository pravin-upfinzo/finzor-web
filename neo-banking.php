...
$meta_lines .= '<meta name="keywords" content="Bank account access,mobile money transfer, contactless payments, realtime banking, financial management">';
...
<section id="fz_product_list_hero_sec" class="section_start" active-menu="list-menu-service" active-submenu="finbankz" active-submenu-l2="finbankz-neobanking">
    ...
    <section id="fz_product_list_banner_sec">
        <div class="container">
            <img src="./assets/images/product_banner/neo_banking.svg" alt="product-banner" class="fz_product_list_banner_img">
        </div>
    </section>
</section>
        ...
        <div class="row">
            <div class="col-lg-7 fz_enhance_col left-space">
                <div class="fz_ai_enhance_text">
                    <h2>AI-Driven Support & Seamless Digital Services </h2>
                    <p class="fz_enhance_para">Finzor enables seamless customer support through advanced AI chatbots available around the clock. All banking services are fully digital, offering effortless transactions and service access via apps or websites, ensuring an enhanced user experience and optimized performance
                    </p>
                    <ul>
                        <li>
            ...
            <div class="col-lg-5 fz_enhance_img_col">
                <div class="fz_ai_enhance_img zoom-in-cbs">
                    <img src="./assets/images/product_sec_1_images/neo_banking_sec1.svg" alt="CBS">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="product_list_feature_cards spotlight-effect">
            ...
            <div class="product_list_feature_card fade-down product_center">
                <div class="product_list_feature_cont">
                    <img src="./assets/images/feature-card-icons/neopulse_payment-transform.svg" alt="digital payment">
            ...
            <div class="product_list_feature_card fade-left">
                <div class="product_list_feature_cont">
                    <img src="./assets/images/feature-card-icons/neopulse_api.svg" alt="digital payment">
            ...
            <div class="product_list_feature_card fade-right">
                <div class="product_list_feature_cont">
                    <img src="./assets/images/feature-card-icons/neopulse_next-gen.svg" alt="digital payment">
            ...
            <div class="product_list_feature_card fade-up">
                <div class="product_list_feature_cont">
                    <img src="./assets/images/feature-card-icons/neopulse_real-time-data.svg" alt="digital payment">
...
<section class="fz_features_sec">
    <div class="container">
        <h2>Neo Banking</h2>
        <p class="fz_features_heading_para">Neo banking is redefining financial services with API-driven connectivity, real-time insights, seamless payments, and advanced security. Experience faster, smarter, and more personalized banking</p>
        <div class="row">
            <div class="col-lg-6">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="onTabClick('v-pills-home')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Seamless Payments & Smart Banking</h4>
                        </div>
                        <p class="fz_feature_para">
                        Effortlessly manage payments, transfers, deposits, and real-time alerts. Experience secure, fast, and hassle-free digital banking with next-gen financial solutions
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="onTabClick('v-pills-profile')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>API-Driven Connectivity & Insights</h4>
                        </div>
                        <p class="fz_feature_para">
                        Leverage powerful APIs for seamless integration, real-time data insights, and enhanced banking experiences. Optimize efficiency with a fully connected ecosystem
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="onTabClick('v-pills-messages')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Advanced Security & Fraud Prevention</h4>
                        </div>
                        <p class="fz_feature_para">
                        Protect your digital banking with next-gen authentication, AI-driven fraud detection, and real-time monitoring. Ensure secure transactions with cutting-edge technology
                        </p>
                    </button>
                </div>
            </div>
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        <div class="fz_features_img zoom-in-fe">
                            <img src="./assets/images/product_tab_images/neopulse_01.svg" alt="neopulse">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        <div class="fz_features_img zoom-in-fe">
                            <img src="./assets/images/product_tab_images/neopulse_02.svg" alt="neopulse">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <div class="fz_features_img zoom-in-fe">
                            <img src="./assets/images/product_tab_images/neopulse_03.svg" alt="neopulse">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="fz_ai_enhance_img zoom-in-sec3">
                    <img src="./assets/images/product_sec_3_images/neoplus.svg" alt="">
                </div>
            </div>
            <div class="col-lg-7 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    <h2>Supply chain & Finance</h2>
                    <p class="fz_enhance_para">Financing solutions to optimize for receivables and payables
                    </p>
                    <ul>
                        <li>
