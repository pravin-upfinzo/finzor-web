...
<section id="fz_product_list_banner_sec">
    <div class="container">
        <img src="./assets/images/product_banner/connected_banking.svg" alt="product-banner" class="fz_product_list_banner_img">
    </div>
</section>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 fz_enhance_img_col">
                <div class="fz_ai_enhance_img zoom-in-cbs">
                    <img src="./assets/images/product_sec_1_images/connected_banking_sec1.svg" alt="CBS">
                </div>
            </div>
        </div>
    </div>
...
<section class="fz_features_sec">
    <div class="container">
        <h2>Interconnected Financial Platform</h2>
        <p class="fz_features_heading_para">At Finzor integrates financial services, offering seamless access, real-time payments, personalized solutions, and advanced security powered by APIs and data analytics.</p>
        <div class="row">
            <div class="col-lg-6">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="onTabClick('v-pills-home')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Seamless Integration for a Unified Financial Experience</h4>
                        </div>
                        <p class="fz_feature_para">
                        Finzor’s Connected Banking integrates various financial services into a single platform using cutting-edge APIs and cloud technology, offering customers seamless, cross-platform access to banking services.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="onTabClick('v-pills-profile')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Real-Time Payments, Personalized Solutions for Every User</h4>
                        </div>
                        <p class="fz_feature_para">
                        Our Connected Banking ensures instant, real-time payments while providing personalized financial services and tailored recommendations, powered by data insights for a smarter banking experience.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="onTabClick('v-pills-messages')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Advanced Security & Analytics for Smarter Banking Decisions</h4>
                        </div>
                        <p class="fz_feature_para">
                        Finzor’s Connected Banking uses advanced security measures to protect data and integrates AI-driven analytics to offer predictive insights, enhancing both customer security and financial decision-making.
                        </p>
                    </button>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="fz_ai_enhance_img zoom-in-sec3">
                    <img src="./assets/images//product_sec_3_images/finbridge.svg" alt="">
                </div>
            </div>
            <div class="col-lg-7 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    <h2>Effortless Payments & Reconciliation with Connected Banking</h2>
                    <p class="fz_enhance_para">Connected Banking enhances financial management with Automated Reconciliation, which matches transactions in real time, reducing errors and manual effort. Virtual Account Numbers streamline payment tracking by assigning unique IDs for each transaction, improving transparency and efficiency. Seamless UPI Integration ensures instant, secure, and hassle-free payments, enabling businesses and individuals to manage finances effortlessly across multiple banking platforms.
                    </p>
                    <ul>
                        <li>
