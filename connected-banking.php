...
<section id="fz_product_list_hero_sec">
    ...
    <div class="container">
        <div class="product_list_hero">
            <h2 class="product_list_hero_title"> Connecting technology and finance seamlessly from <span>NexPulse</span></h2>
...
<section id="fz_product_list_banner_sec">
    <div class="container">
        <img src="./assets/images/Merchan Onboarding.svg" alt="product-banner" class="fz_product_list_banner_img">
    </div>
</section>
