...
<section id="fz_product_list_hero_sec" class="section_start" active-menu="list-menu-service" active-submenu="upizor" active-submenu-l2="payment-gateway">
    <canvas class="hero_sec_dot" id="hero_sec_dot"></canvas>
    <div class="container">
        <div class="product_list_hero">
            <h2 class="product_list_hero_title"><span> Flowgate </span> Swift, secure, and reliable payments </h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 fz_enhance_img_col">
                <div class="fz_ai_enhance_img zoom-in-cbs">
                    <img src="./assets/images/product_sec_1_images/payment_gateways_sec1.svg" alt="CBS">
                </div>
            </div>
        </div>
    </div>
...
<section class="fz_features_sec">
    <div class="container">
        ...
        <p class="fz_features_heading_para">Finzor’s Payment Gateway offers multiple payment methods, secure transactions, and real-time analytics. Customize fees, manage revenue operations, and prevent fraud with AI-powered features for seamless business growth.</p>
        <div class="row">
            <div class="col-lg-6">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="onTabClick('v-pills-home')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Comprehensive Payment Method Support</h4>
                        </div>
                        <p class="fz_feature_para">
                        Support multiple payment methods across platforms. From credit cards to wallets, provide your customers with a flexible and secure payment experience anytime, anywhere.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="onTabClick('v-pills-profile')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>AI-Powered Fraud Detection & Security</h4>
                        </div>
                        <p class="fz_feature_para">
                        Ensure secure transactions with encryption and AI-powered fraud detection. Protect your business and customers with real-time alerts and advanced security measures.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="onTabClick('v-pills-messages')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Seamless Integration & Analytics</h4>
                        </div>
                        <p class="fz_feature_para">
                        Access a real-time analytics dashboard, track performance, and optimize transactions. Easily integrate with your business systems for streamlined financial and payments operations.
                        </p>
                    </button>
                </div>
            </div>
            <div class="col-lg-6 fz_tab_images_features">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        ...
                        <img src="./assets/images/product_tab_images/flowgate_01.svg" alt="flowgate_01">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/flowgate_02.svg" alt="flowgate_02">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/flowgate_03.svg" alt="flowgate_03">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="fz_ai_enhance_img zoom-in-sec3">
                    <img src="./assets/images//product_sec_3_images/flowgate.svg" alt="">
                </div>
            </div>
            <div class="col-lg-7 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    <h2>Go above and beyond</h2>
                    <p class="fz_enhance_para">Do you have a social media presence but not your own web shop? We’ll help you tap into digital sales, using payment links you can easily integrate into conversations with shoppers.
                    </p>
                    <ul>
                        <li>
