...
<section class="fz_features_sec">
    <div class="container">
        <h2>UPI</h2>
        <p class="fz_features_heading_para">Finzor’s all-in-one UPI solution empowers merchants with seamless payment acceptance via UPI ID, QR codes, and linked apps. Enjoy secure, real-time payment processing and automatic reconciliation.</p>
        <div class="row">
            <div class="col-lg-6">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="onTabClick('v-pills-home')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Effortless P2P & P2M Transactions</h4>
                        </div>
                        <p class="fz_feature_para">
                        Simplify payments with easy Person-to-Person (P2P) and Person-to-Merchant (P2M) transactions. Secure, fast, and reliable payments for businesses and consumers.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="onTabClick('v-pills-profile')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Manage Multiple Accounts in One App</h4>
                        </div>
                        <p class="fz_feature_para">
                        Link multiple bank accounts in a single app for smooth and unified payment processing. Manage your finances and transactions effortlessly across platforms.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="onTabClick('v-pills-messages')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Scheduled & Payment Link Features</h4>
                        </div>
                        <p class="fz_feature_para">
                        Enable scheduled payments and generate payment links for better transaction control. Enhance business efficiency with automated payments and streamlined collections.
                        </p>
                    </button>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    <h2>Enable seamless merchant transactions</h2>
                    <p class="fz_enhance_para">Integrate a UPI payment gateway to allow customers to pay via UPI ID or QR code, ensuring fast, secure transactions. Enable real-time payment notifications and automatic reconciliation for merchants. 
                    </p>
                    <ul>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color"> Instant money transfers</span><span class="normal_text"> 24/7 with just a mobile number.</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color"> Secure & seamless payments</span><span class="normal_text"> using UPI-enabled apps.</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color">No need for bank details</span><span class="normal_text"> pay directly via UPI ID.</span>
                        </li>
                    </ul>
                </div>
            </div>
