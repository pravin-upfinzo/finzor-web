        ...
        <div class="row">
            <div class="col-lg-7 fz_enhance_col left-space">
                <div class="fz_ai_enhance_text">
                    ...
                    <ul>
                        <li>
                            <p><span class="fz_cbs_color">AI-driven fraud detection </span>for enhanced security</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Enable data-driven strategies </span>with real-time analytics</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Streamline secure, </span>real-time cloud data access</p>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-5 fz_enhance_img_col">
                <div class="fz_ai_enhance_img zoom-in-cbs">
                    <img src="./assets/images/product_sec_1_images/finlyticz_sec1.svg" alt="CBS">
                </div>
            </div>
        </div>
    </div>
...
<section class="fz_features_sec">
    <div class="container">
        ...
        <p class="fz_features_heading_para">At Finzor, we harness the power of data analytics to drive smarter decisions and innovative solutions. Data analytics is the core of transformation, helping fintech businesses stay competitive and exceed customer expectations.</p>
        <div class="row">
            <div class="col-lg-6">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="onTabClick('v-pills-home')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Unlock Smarter Decisions with Data Analytics</h4>
                        </div>
                        <p class="fz_feature_para">
                        Leverage data analytics to make informed, actionable decisions. From customer insights to market trends, drive business strategies and stay ahead in the fintech landscape.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="onTabClick('v-pills-profile')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Advanced Market Trend & Risk Analysis</h4>
                        </div>
                        <p class="fz_feature_para">
                        Utilize cutting-edge analytics to track market trends and assess risks. Make proactive decisions in credit scoring, risk management, and portfolio optimization with real-time insights.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="onTabClick('v-pills-messages')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Boost Operational Efficiency with Data-Driven Insights</h4>
                        </div>
                        <p class="fz_feature_para">
                        Improve operational efficiency by analyzing data trends, identifying bottlenecks, and optimizing workflows. Enhance productivity while reducing costs across your business.
                        </p>
                    </button>
                </div>
            </div>
            <div class="col-lg-6 fz_tab_images_features">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        ...
                        <img src="./assets/images/product_tab_images/finlyticz_01.svg" alt="finlyticz_01">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/finlyticz_02.svg" alt="finlyticz_02">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/finlyticz_03.svg" alt="finlyticz_03">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="fz_ai_enhance_img zoom-in-sec3">
                    <img src="./assets/images//product_sec_3_images/finanalytic.svg" alt="">
                </div>
            </div>
            <div class="col-lg-7 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    <h2>Optimizing Security and Efficiency with Data-Driven Solutions                    </h2>
                    ...
                    <ul>
                        <li>
                            <p><span class="fz_cbs_color">Real-Time Fraud Detection</span> analyze patterns and spot anomalies</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Enhanced Trust & Security</span> safeguard transactions and user data</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Cost-Efficient Operations</span> automate workflows and scale seamlessly</p>
                        </li>
                    </ul>
                </div>
            </div>
