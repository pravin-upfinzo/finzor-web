        ...
        <div class="row">
            <div class="col-lg-6 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    <h2>Transforming the Fintech Landscape</h2>
                    <p class="fz_enhance_para">At Finzor, we believe data analytics is at the heart of innovation in the fintech ecosystem, enabling smarter decisions and game-changing solutions.
                    </p>
                    <ul>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color">Improves</span><span class="normal_text">Bespoke investment recommendations</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color">Ensures</span><span class="normal_text">Tailored insurance policies</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color">Better Efficiency</span><span class="normal_text">Customized credit and loan offerings</span>
                        </li>
                    </ul>
                </div>
            </div>
