...
<section id="fz_product_list_hero_sec" class="section_start" active-menu="list-menu-service" active-submenu="finbankz" active-submenu-l2="finbankz-intbanking">
    <canvas class="hero_sec_dot" id="hero_sec_dot"></canvas>
    <div class="container">
        <div class="product_list_hero">
            <h2 class="product_list_hero_title"><span> Webvault </span> Empower finances through online banking</h2>
    ...
    <section id="fz_product_list_banner_sec">
        <div class="container">
            <img src="./assets/images/product_banner/internet_banking.svg" alt="product-banner" class="fz_product_list_banner_img">
        </div>
    </section>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 fz_enhance_img_col">
                <div class="fz_ai_enhance_img zoom-in-cbs">
                    <img src="./assets/images/product_sec_1_images/internet_banking_sec1.svg" alt="CBS">
                </div>
            </div>
        </div>
    </div>
...
<section class="fz_features_sec">
    <div class="container">
        ...
        <p class="fz_features_heading_para">Finzor revolutionizes internet banking with seamless integration across mobile and web platforms. Manage accounts, execute transactions, and receive real-time updates securely on any device</p>
        <div class="row">
            <div class="col-lg-6">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="onTabClick('v-pills-home')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Seamless Multi-Device Banking</h4>
                        </div>
                        <p class="fz_feature_para">
                        Access your banking services anytime, anywhere. Whether on mobile or desktop, enjoy consistent functionality, secure transactions, and real-time updates across devices
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="onTabClick('v-pills-profile')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>AI-Driven Payment Analytics</h4>
                        </div>
                        <p class="fz_feature_para">
                        Leverage automated payment analytics and insights to track spending, optimize transactions, and gain valuable data for smarter decision-making in real-time
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="onTabClick('v-pills-messages')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Blockchain-Powered Security</h4>
                        </div>
                        <p class="fz_feature_para">
                        Ensure the highest level of security with blockchain-based technology, protecting your transactions while providing secure, fast, and transparent financial solutions
                        </p>
                    </button>
                </div>
            </div>
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        <div class="fz_features_img zoom-in-fe">
                            <img src="./assets/images/product_tab_images/webvault_01.svg" alt="webvault">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        <div class="fz_features_img zoom-in-fe">
                            <img src="./assets/images/product_tab_images/webvault_02.svg" alt="webvault">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <div class="fz_features_img zoom-in-fe">
                            <img src="./assets/images/product_tab_images/webvault_03.svg" alt="webvault">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-7 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    ...
                    <p class="fz_enhance_para">Ensures that data transmitted between users and banking platforms is securely encrypted, preventing unauthorized access during transmission. Only the sender and receiver can decrypt the information, safeguarding sensitive financial data from potential threats
                    </p>
                    <ul>
                        <li>
