...
<section id="fz_product_list_hero_sec" class="section_start" active-menu="list-menu-service" active-submenu="finopz" active-submenu-l2="finopz-settlement">
    <canvas class="hero_sec_dot" id="hero_sec_dot"></canvas>
    <div class="container">
        <div class="product_list_hero">
            <h2 class="product_list_hero_title"><span> Finlease</span> Effortless, secure, and timely settlements</h2>
    ...
    <section id="fz_product_list_banner_sec">
        <div class="container">
            <img src="./assets/images/product_banner/settlements.svg" alt="product-banner" class="fz_product_list_banner_img">
        </div>
    </section>
</section>
        ...
        <div class="row">
            <div class="col-lg-7 fz_enhance_col left-space">
                <div class="fz_ai_enhance_text">
                    ...
                    <ul>
                        <li>
                            <p><span class="fz_cbs_color">Simplified Payment Integration </span>connect PSPs for seamless transactions</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Maximize Efficiency with Routing </span>ensure cost-effective, faster processing</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Automate Reconciliation </span>eliminate errors and streamline settlement</p>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-5 fz_enhance_img_col">
                <div class="fz_ai_enhance_img zoom-in-cbs">
                    <img src="./assets/images/product_sec_1_images/settlements_sec1.svg" alt="CBS">
                </div>
            </div>
        </div>
    </div>
...
<section class="fz_features_sec">
    <div class="container">
        <h2>Settlements</h2>
        <p class="fz_features_heading_para">Payment settlement efficiently transfers funds to merchants, ensuring swift, secure transactions. With real-time systems and customizable thresholds, businesses benefit from faster, more reliable financial operations.</p>
        <div class="row">
            <div class="col-lg-6">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="onTabClick('v-pills-home')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Efficient Fund Transfers & Customizable Thresholds</h4>
                        </div>
                        <p class="fz_feature_para">
                        Move funds seamlessly to merchants with customizable settlement thresholds. Improve cash flow and operational efficiency with faster fund transfers, tailored to your business needs.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="onTabClick('v-pills-profile')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Real-Time Payments & Instant Dispute Resolution</h4>
                        </div>
                        <p class="fz_feature_para">
                        Accelerate operations with real-time payments, enhancing the speed and accuracy of settlements. Instantly resolve disputes and manage chargebacks for a smoother transaction process.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="onTabClick('v-pills-messages')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Comprehensive Tax Reporting & API Integration</h4>
                        </div>
                        <p class="fz_feature_para">
                        Simplify tax calculation and reporting for settlements with integrated tools. Use our API to automate settlement processes and gain full control over financial reporting and reconciliation.
                        </p>
                    </button>
                </div>
            </div>
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        <div class="fz_features_img zoom-in-fe">
                            <img src="./assets/images/product_tab_images/finlease_01.svg" alt="finlease_01">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/finlease_02.svg" alt="finlease_02">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/finlease_03.svg" alt="finlease_03">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="fz_ai_enhance_img zoom-in-sec3">
                    <img src="./assets/images//product_sec_3_images/finlease.svg" alt="">
                </div>
            </div>
            <div class="col-lg-7 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    ...
                    <ul>
                        <li>
                            <p><span class="fz_cbs_color">Fast & secure fund settlements </span> for smooth transactions</span></p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Automated reconciliation </span> to enhance accurate payouts</span></p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Real-time tracking </span> of settlement status & reports</p>
