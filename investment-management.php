...
<section id="fz_product_list_hero_sec" class="section_start" active-menu="list-menu-service" active-submenu="finopz" active-submenu-l2="finopz-invest">
    ...
    <div class="container">
        <div class="product_list_hero">
            <h2 class="product_list_hero_title"><span> FinInvezt</span> Build Today, Thrive Tomorrow </h2>
        ...
        <div class="row">
            <div class="col-lg-7 fz_enhance_col left-space">
                <div class="fz_ai_enhance_text">
                    ...
                    <ul>
                        <li>
                            <p><span class="fz_cbs_color">Gen AI customizes strategies</span> based on risk, goals, and preferences</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Dynamic Recommendations</span> respond to change on the market trends</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Personalized Financial Guidance </span>accessible strategies for all audiences</p>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-5 fz_enhance_img_col">
                <div class="fz_ai_enhance_img zoom-in-cbs">
                    <img src="./assets/images/product_sec_1_images/investment_management_sec1.svg" alt="CBS">
                </div>
            </div>
        </div>
    </div>
...
<section class="fz_features_sec">
    <div class="container">
        <h2>Gen AI in Investment Management</h2>
        <p class="fz_features_heading_para">Gen AI revolutionizes investment management by analyzing vast datasets, identifying hidden trends, and providing real-time insights. It empowers managers to stay ahead in dynamic markets and optimize strategies.</p>
        <div class="row">
            <div class="col-lg-6">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="onTabClick('v-pills-home')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>AI-Driven Insights for Smarter Decisions</h4>
                        </div>
                        <p class="fz_feature_para">
                        Leverage real-time, actionable insights powered by Gen AI. Enhance decision-making, discover hidden opportunities, and optimize your investment strategies for superior returns.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="onTabClick('v-pills-profile')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Efficient Portfolio & Risk Management</h4>
                        </div>
                        <p class="fz_feature_para">
                        Streamline portfolio management and mitigate risks with advanced AI algorithms. Achieve better asset allocation, diversify investments, and protect against market volatility.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="onTabClick('v-pills-messages')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Optimized Tax Planning & Expense Management</h4>
                        </div>
                        <p class="fz_feature_para">
                        Utilize Gen AI for intelligent tax planning and budgeting. Automate expense tracking, enhance tax efficiency, and manage financial goals effectively for long-term success.
                        </p>
                    </button>
                </div>
            </div>
            <div class="col-lg-6 fz_tab_images_features">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        ...
                        <img src="./assets/images/product_tab_images/fininvezt_01.svg" alt="fininvezt_01">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/fininvezt_02.svg" alt="fininvezt_02">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/fininvezt_03.svg" alt="fininvezt_03">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="fz_ai_enhance_img zoom-in-sec3">
                    <img src="./assets/images//product_sec_3_images/fininvezt.svg" alt="">
                </div>
            </div>
            <div class="col-lg-7 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    <h2>Advanced Risk Management</h2>
                    <p class="fz_enhance_para">Gen AI redefines risk management by detecting emerging risks in real time, simulating market scenarios, and identifying hidden asset correlations. This proactive approach strengthens portfolio resilience, helping firms stay prepared and minimize unexpected losses. 
                    </p>
                    <ul>
                        <li>
                            <p><span class="fz_cbs_color">Grow your wealth smartly </span>with expert investment strategies</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Diversify your portfolio </span>for better risk management</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Track & manage investments </span>with real-time insights</p>
