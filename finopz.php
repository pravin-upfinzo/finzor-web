    ...
    <div class="container">
        <div class="fin_bankz">
            ...
            <div class="fin_bankz_img">
                <div class="finopz-fininvezt"></div>
            </div>
        </div>
    </div>
</section>
...
<section id="fin_bankz_sec" class="fin_bankz">
    <div class="container">
        <div class="fin_bankz">
            <div class="fin_bankz_img">
                <div class="finopz-finalease"></div>
            </div>
            <div class="fin_bankz_content finbank_content">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <div class="get_touch_in_content">
                        ...
                        <img class="get-touch-arrow" src="./assets/images/get_touch_arrow_line.png" alt="Arrow-line">
                    </div>
                </div>
            </div>
        </div>
