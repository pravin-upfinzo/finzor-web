...
<section id="fz_product_list_banner_sec">
    <div class="container">
        <img src="./assets/images/Mobile Banking.svg" alt="product-banner" class="fz_product_list_banner_img">
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-6 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    ...
                    <ul>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color">Instant Payment Processing</span><span class="normal_text"> Enjoy fast, secure transactions anytime</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color">Multi-Layer Security</span><span class="normal_text">Protects data with advanced fraud prevention</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color">Real-Time Transaction Updates</span><span class="normal_text">Stay informed with instant alerts</span>
                        </li>
                    </ul>
                </div>
            </div>
...
<section id="fz_product_list_feature">
    <div class="container">
        ...
        <div class="product_list_feature_cards spotlight-effect">
            ...
            <div class="product_list_feature_card fade-right product_center">
                <div class="product_list_feature_cont">
                    <img src="./assets/images/product_feature_digital.svg" alt="digital payment">
                    <h4>AI Tools</h4>
...
<section class="fz_features_sec">
    <div class="container">
        ...
        <p class="fz_features_heading_para">Mobile banking transforms the way you manage finances, offering open APIs, AI-powered tools, and cloud solutions to streamline payments, enhance security, and offer seamless services</p>
        <div class="row">
            <div class="col-lg-6">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="onTabClick('v-pills-home')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Open APIs for Seamless Integration</h4>
                        </div>
                        <p class="fz_feature_para">
                        Easily integrate mobile banking features with open REST APIs. Connect systems, automate processes, and unlock a new level of operational efficiency
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="onTabClick('v-pills-profile')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>AI Tools for Smarter Banking</h4>
                        </div>
                        <p class="fz_feature_para">
                        Utilize AI in payments reconciliation, predictive analysis, and customer support. Improve decision-making, enhance accuracy, and create a personalized experience for your users
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="onTabClick('v-pills-messages')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Secure & Scalable Cloud Solutions</h4>
                        </div>
                        <p class="fz_feature_para">
                        Leverage cloud-based mobile banking solutions for greater scalability, flexibility, and security. Ensure continuous access while protecting user data and optimizing performance
                        </p>
                    </button>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    <h2>User Authentication and Fraud Prevention</h2>
                    <p class="fz_enhance_para">Mobile banking leverages user authentication and fraud prevention measures, such as biometric verification, to ensure secure access and transactions. This proactive approach mitigates risks and enhances trust in digital banking services
                    </p>
                    <ul>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color"> Secure & convenient banking</span><span class="normal_text">anytime, anywhere on your mobile</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color"> Instant fund transfers & bill payments</span><span class="normal_text">with just a few taps</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt="Tick Mark"><span class="fz_cbs_color">Track expenses & manage accounts</span><span class="normal_text"> with real-time updates
                            </span>
                        </li>
                    </ul>
                </div>
