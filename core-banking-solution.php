        ...
        <div class="row">
            <div class="col-lg-6 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    ...
                    <ul>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt=""><span class="fz_cbs_color">Improves</span><span class="normal_text">Success Rates of Transactions</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt=""><span class="fz_cbs_color">Ensures</span><span class="normal_text">Smooth and Reliable Payment Processes</span>
                        </li>
                        <li>
                            <img src="./assets/images/Tick mark.svg" alt=""><span class="fz_cbs_color">Better Efficiency</span><span class="normal_text">with Smart Routing</span>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-6 fz_enhance_img_col">
                <div class="fz_ai_enhance_img zoom-in-cbs">
                    <img src="./assets/images/cbs_image.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="item">
                <div class="fz_product-content">
                    ...
                    <button class="buttons">
                        ...
                        <div class="icon">
                            <img src="./assets/images/arrow-product.svg" alt="" class="tele_img">
                        </div>
                    </button>
                </div>
