...
<section id="fz_product_list_hero_sec" class="section_start" active-menu="list-menu-service" active-submenu="upizor" active-submenu-l2="upizor-switch">
    <canvas class="hero_sec_dot" id="hero_sec_dot"></canvas>
    <div class="container">
        <div class="product_list_hero">
            <h2 class="product_list_hero_title"><span> FinzSwitch </span> Unified UPI for seamless interoperability</h2>
        ...
        <div class="row">
            <div class="col-lg-7 fz_enhance_col left-space">
                <div class="fz_ai_enhance_text">
                    ...
                    <ul>
                        <li>
                            <p><span class="fz_cbs_color">Experience improved payment </span>success efficiency boosting through switch</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Optimized Transactions </span>ensure under 100ms latency for quicker transactions</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Uninterrupted Service </span>achieve 99.99% uptime performance</p>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-5 fz_enhance_img_col">
                <div class="fz_ai_enhance_img zoom-in-cbs">
                    <img src="./assets/images/product_sec_1_images/upi_switch_sec1.svg" alt="CBS">
                </div>
            </div>
        </div>
    </div>
...
<section class="fz_features_sec">
    <div class="container">
        <h2>UPI Switch</h2>
        <p class="fz_features_heading_para">Finzor's UPI Switch solution offers seamless integration with accounting and ERP systems. Enjoy secure, flexible, and efficient payment routing, fraud detection, and advanced transaction security features.</p>
        <div class="row">
            <div class="col-lg-6">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="onTabClick('v-pills-home')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Effortless Integration with Accounting Systems</h4>
                        </div>
                        <p class="fz_feature_para">
                        Integrate UPI payments with your accounting and ERP systems. Streamline operations, simplify bookkeeping, and ensure smooth financial management with automated transactions.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="onTabClick('v-pills-profile')">
                        ...
                        <p class="fz_feature_para">
                        Enhance payment security with Two-Factor Authentication (2FA), fraud detection, and real-time alerts. Safeguard your transactions with cutting-edge security technologies.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="onTabClick('v-pills-messages')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Flexible Payment Management</h4>
                        </div>
                        <p class="fz_feature_para">
                        Simplify recurring payments, manage refunds, and resolve disputes easily. Optimize payment flows with smart routing and tokenization for added transaction security.
                        </p>
                    </button>
                </div>
            </div>
            <div class="col-lg-6 fz_tab_images_features">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        ...
                        <img src="./assets/images/product_tab_images/finzswitch_01.svg" alt="finzswitch_01">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/finzswitch_02.svg" alt="finzswitch_02">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/finzswitch_03.svg" alt="finzswitch_03">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="fz_ai_enhance_img zoom-in-sec3">
                    <img src="./assets/images//product_sec_3_images/finswitch.svg" alt="">
                </div>
            </div>
            <div class="col-lg-7 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    <h2>Enhanced User Experience</h2>
                    <p class="fz_enhance_para">Ultimately, the goal of UPI Switch is to enhance the overall user experience. As it evolves, we can expect even faster transaction times, higher success rates, and more seamless integration with various banking and payment platforms. 
                    </p>
                    <ul>
                        <li>
                            <p><span class="fz_cbs_color"> Seamless routing of UPI </span> transactions for better reliability</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color"> Smart load balancing </span> across multiple banks & networks</p>
                        </li>
                        <li>
                            <p><span class="fz_cbs_color">Ensures high success rates </span> with faster & secure payments</p>
                        </li>
                    </ul>
                </div>
            </div>
