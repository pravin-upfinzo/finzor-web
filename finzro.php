...
<section id="fz_product_list_hero_sec" class="section_start" active-menu="list-menu-service" active-submenu="finzro">
    ...
    <section id="fz_product_list_banner_sec">
        <div class="container">
            <img src="./assets/images/product_banner/merchan_onboarding.svg" alt="product-banner" class="fz_product_list_banner_img">
        </div>
    </section>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 fz_enhance_img_col">
                <div class="fz_ai_enhance_img zoom-in-cbs">
                    <img src="./assets/images/product_sec_1_images/finzro_sec1.svg" alt="CBS">
                </div>
            </div>
        </div>
    </div>
...
<section class="fz_features_sec">
    <div class="container">
        <h2>Merchant Onboarding Solutions</h2>
        <p class="fz_features_heading_para">Finzor’s merchant onboarding solutions streamline the entire process with automated workflows, real-time status updates, and AI-driven fraud prevention. Secure API integration ensures smooth, efficient, and compliant onboarding.</p>
        <div class="row">
            <div class="col-lg-6">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true" onclick="onTabClick('v-pills-home')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Simplified Onboarding with Real-Time Updates</h4>
                        </div>
                        <p class="fz_feature_para">
                        Easily onboard merchants with our intuitive dashboard. Track progress, manage compliance, and stay informed with real-time status updates throughout the process.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" onclick="onTabClick('v-pills-profile')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>Seamless Integration & API Connectivity</h4>
                        </div>
                        <p class="fz_feature_para">
                        Integrate securely with payment platforms through Finzor’s robust API. Ensure smooth connectivity, fast onboarding, and efficient payment processing for businesses.
                        </p>
                    </button>
                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="onTabClick('v-pills-messages')">
                        <div class="fz_feature_tab_heading">
                            ...
                            <h4>AI-Enhanced Fraud Prevention & Compliance</h4>
                        </div>
                        <p class="fz_feature_para">
                        Leverage AI-powered verification to reduce fraud and ensure strict regulatory compliance during the merchant onboarding process, enabling a secure and fast experience.
                        </p>
                    </button>
                </div>
            </div>
            <div class="col-lg-6 fz_tab_images_features">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        ...
                        <img src="./assets/images/product_tab_images/finzro_01.svg" alt="finzro_01">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/finzro_02.svg" alt="finzro_02">
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <div class="fz_features_img zoom-in-fe">
                        <img src="./assets/images/product_tab_images/finzro_03.svg" alt="finzro_03">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="fz_ai_enhance_img zoom-in-sec3">
                    <img src="./assets/images//product_sec_3_images/finzro.svg" alt="">
                </div>
            </div>
            <div class="col-lg-7 fz_enhance_col">
                <div class="fz_ai_enhance_text">
                    <h2>Diverse Payment Methods</h2>
                    <p class="fz_enhance_para">Merchant onboarding allows businesses to accept payments through various channels, including credit/debit cards, digital wallets, and NetBanking. This flexibility safeguards customers’ ability to pay using their preferred method. 
                    </p>
                    <ul>
                        <li>
